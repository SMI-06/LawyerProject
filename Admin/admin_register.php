...
if (isset($_REQUEST['btn_register'])) {
    ...
    $confirm_password = $_REQUEST['aconfirm_password'];
    ...
    if ($duplicate->rowCount() > 0) {
        ...
        if ($username == "" || $email == "" || $password == "" || $confirm_password == "") {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                $message = "<div class='alert alert-success'>Admin Registeration successfully completed.</div>";
            }
        }
    }
}
...
<head>
    ...
    <title>Lawyers Website - Admin Register</title>
    <!-- plugins:css -->
                            ...
                            <div style="background-color: #151515;" class="auth-form-light text-left py-5 px-4 px-sm-5">
                                ...
                                <form class="pt-3" method="POST">
                                    <div class="form-group">
                                        <input name="ausername" type="text" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Username">
                                    </div>
                                    <div class="form-group">
                                        <input name="aemail" type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                                    </div>



                                    <div class="form-group">
                                        <input name="apassword" type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password">
                                    </div>
                                    <div class="form-group">
                                        <input name="aconfirm_password" type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Confirm Password">
                                    </div>
                                    ...
                                    <div class="text-center mt-4 font-weight-light">
                                        Already have an account? <a href="admin_login.php" class="" style="color:  #D7B679;">Login</a>
                                    </div>

...
if (isset($_REQUEST['btn_register'])) {
    ...
    $confirm_password = $_REQUEST['cconfirm_password'];
    ...
    if ($duplicate->rowCount() > 0) {
        ...
        if ($username == "" || $email == "" || $password == "" || $confirm_password == "") {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                $message = "<div class='alert alert-success'>Client Registeration successfully completed.</div>";
            }
        }
    }
}
...
<?php if (isset($_SESSION['role']) == "Client") {
    ...
    <head>
        ...
        <title>Lawyers Website - Client Register</title>
        <!-- plugins:css -->
                    ...
                    <div class="row w-100 mx-0">
                        <div class="col-lg-4 mx-auto">
                            <div style="background-color: #151515;" class="auth-form-light text-left py-5 px-4 px-sm-5">
                                ...
                                <h3 class="text-center">Client Registeration</h3>

                                <form class="pt-3" method="post">
                                    <div class="form-group">
                                        <input name="cusername" type="text" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Username">
                                    </div>
                                    <div class="form-group">
                                        <input name="cemail" type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                                    </div>



                                    <div class="form-group">
                                        <input name="cpassword" type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password">
                                    </div>
                                    <div class="form-group">
                                        <input name="cconfirm_password" type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Confirm Password">
                                    </div>
                                    ...
                                    <div class="text-center mt-4 font-weight-light">
                                        Already have an account? <a href="client_login.php" class="" style="color:  #D7B679;">Login</a>
                                    </div>

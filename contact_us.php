...
$title = "Lawyers Website - Contact us";
$activepage = 'contact us';
$pagename = 'Contact Us';
$present_page = 'Contact Us';
$page = 'contact_us.php';
        ...
        <div class="row gy-5">
                ...
                <div class="address-area">
                    ...
                    <ul class="address-list sibling3">
                        ...
                        <li>
                            ...
                            <div class="text">
                                <h4>Email</h4>
                                <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#a0c9cec6cfe0c5d8c1cdd0ccc58ec3cfcd"><span class="__cf_email__" data-cfemail="93fafdf5fcd3f6ebf2fee3fff6bdf0fcfe">[email&#160;protected]</span> </a> <br>
                                <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#afdcdadfdfc0dddbefcad7cec2dfc3ca81ccc0c2"><span class="__cf_email__" data-cfemail="0b787e7b7b64797f4b6e736a667b676e25686466">[email&#160;protected]</span></a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-6 text-md-start text-center">
                ...
                if (isset($_REQUEST['btnsubmit'])) {
                    ...
                    $email1 = $_REQUEST['uemail'];
                    $phone = $_REQUEST['uphone'];
                    $message = $_REQUEST['umassage'];
                    if ( $phone == "" || $message == "") { ?>
                        <script type="text/javascript">
                            alert("Please Fill All Records !!!");
                        </script>
                        <?php } elseif (isset($_SESSION['role']) == "Client" || $_SESSION['role'] == "Admin") {

                        $query = "INSERT INTO `contact_us`( `Name`, `Email`, `Phone_no`, `Message`) VALUES (:uname,:uemail,:uphone,:umessage)";

                        $pdo_statement = $pdo_con->prepare($query);
                        $pdo_statement->bindParam(':uname', $name, PDO::PARAM_STR);
                        $pdo_statement->bindParam(':uemail', $email, PDO::PARAM_STR);
                        $pdo_statement->bindParam(':uphone', $phone, PDO::PARAM_STR);
                        $pdo_statement->bindParam(':umessage', $message, PDO::PARAM_STR);
                        $pdo_statement->execute();
                        $success = "Message Sent Successfully";
                        echo "<script> window.location.href='contact_us.php' . $success; </script>";
                    } elseif (isset($_SESSION['role']) == "") {
                        if ($name1 == "" || $email1 == "" || $phone == "" || $message == "") { ?>
                            <script type="text/javascript">
                                alert("Please Fill All Recordsdddddd !!!");
                            </script>
                <?php   } else {
                            $query = "INSERT INTO `contact_us`( `Name`, `Email`, `Phone_no`, `Message`) VALUES (:uname,:uemail,:uphone,:umessage)";

                            $pdo_statement = $pdo_con->prepare($query);
                            $pdo_statement->bindParam(':uname', $name1, PDO::PARAM_STR);
                            $pdo_statement->bindParam(':uemail', $email1, PDO::PARAM_STR);
                            $pdo_statement->bindParam(':uphone', $phone, PDO::PARAM_STR);
                            $pdo_statement->bindParam(':umessage', $message, PDO::PARAM_STR);
                            $pdo_statement->execute();
                            $success = "Message Sent Successfully";
                ...
                <?php if (isset($_SESSION['role']) == "Client" || isset($_SESSION['role']) == "Admin" ) { ?>
                    <form class="contact-form" method="post">
                        <div class="row">
                            <div class="col-lg-12">

                                <div class="form-inner sibling2">
                                    <input readonly type="text" placeholder="<?php echo $_SESSION['username'] ?>">
                                </div>

                            </div>
                            <div class="col-lg-6">
                                <div class="form-inner sibling2">
                                    <input readonly type="email" placeholder="<?php echo $_SESSION['email'] ?>">
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-inner sibling2">
                                    <input required name="uphone" type="text" placeholder="Enter your Phone" max='15'>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-inner sibling2">
                                    <textarea required name="umassage" rows="5" placeholder="Your message"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 text-lg-start text-center">
                                <button name="btnsubmit" type="submit" class="eg-btn btn--outline btn--lg sibling3 capsule">
                                    Send Message &nbsp;<svg width="18" height="15" viewBox="0 0 22 13" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <form class="contact-form" method="post">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-inner sibling2">
                                    <input required name="uname" type="text" placeholder="Enter Your Name">
                                </div>

                            </div>
                            <div class="col-lg-6">
                                <div class="form-inner sibling2">
                                    <input required name="uemail" type="email" placeholder="Enter Your Email">
                                </div>

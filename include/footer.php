                        ...
                        <ul class="contact-list">
                            <li>
                                ...
                                <div class="text">
                                    ...
                                    <a href="tel:+8801761111458" class="mb-0">+880 176 1111 458</a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="recent-caselist">
                            <li>
                                ...
                                <div class="text">
                                    <span>skirmish</span>
                                    <h5><a href="casestudy-details.html">Education Law</a></h5>
                                </div>
                            </li>
                            <li>
                                <div class="image">
                                ...
                                <div class="text">
                                    <span>skirmish</span>
                                    <h5><a href="casestudy-details.html">Personal injury</a></h5>
                                </div>
                            </li>
                            <li>
                                <div class="image">
                                ...
                                <div class="text">
                                    <span>skirmish</span>
                                    <h5><a href="casestudy-details.html">Drug Offense</a></h5>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="row d-flex align-items-center g-3">
                <div class="col-lg-6 d-flex justify-content-lg-start justify-content-center text-lg-start text-center px-1">
                    <p>Copyright 2023 <a href="index.php" class="egns-lab">Core Law </a> | Design By <a href="##" class="egns-lab">Afaque Ahmed</a></p>
                </div>
